			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
						document.getElementById("txtResultado"+i).style.backgroundColor="rgb(126, 230, 117)";
					}else{
						document.getElementById("txtResultado"+i).style.backgroundColor="rgb(236, 67, 67)";
					}
				}
			}
		}
